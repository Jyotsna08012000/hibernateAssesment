   ...
   <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
            ...
            <li> <a class="color3" href="sign-up.jsp">Sign Up</a></li>
				...
				<%} %>
					<form action="UserController" method="post">
						...
						<div>
							...
							<input type="text"  name="email" placeholder="jhg@gmail.com" required="" >						
						</div>
						<div>
							<span>Mobile</span>		
							<input type="text"  name="mobile" placeholder="+910000000000" required=""  >	
						</div>
						<div>
							<span>Address </span>		
						...
						<div>
							<span>Password </span>		
							<input type="text"  name="password" placeholder="1235kjnbh" required=""  >						
						</div>
						<div>
							<span>Confirm Password </span>		
							<input type="text"  name="confirmpassword" placeholder="1235kjnbh" required="" >						
						</div>
